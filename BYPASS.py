...
MM"""""""`MM MMP"""""""MM MM""""""""`M M""M 
MM  mmmm,  M M' .mmmm  MM MM  mmmmmmmM M  M 
M'        .M M         `M M'      MMMM M  M 
MM  MMMb. "M M  MMMMM  MM MM  MMMMMMMM M  M 
MM  MMMMM  M M  MMMMM  MM MM  MMMMMMMM M  M 
MM  MMMMM  M M  MMMMM  MM MM  MMMMMMMM M  M 
MMMMMMMMMMMM MMMMMMMMMMMM MMMMMMMMMMMM MMMM 
                                            
                                         
  \033[91;1m  ╔════════════════════════════════════════=========╗
   {H} ║{P}[{H}•{P}] Author    :{M} 𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘                 {N}{H}       ║
  {H}  ║{P}[{H}•{P}] Facebook  : {H} 𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑      {N}{H}     ║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+01877721475.           {N}{H}       ║
...
MMMMMMMMMMMM MMMMMMMMMMMM MMMMMMMMMMMM MMMM 
  ...
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{M} 𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘         {N}{H}    ║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}𝐑𝐀𝐅𝐈 𝐂𝐇𝐎𝐖𝐃𝐇𝐔𝐑𝐘    {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+01877721475.           {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/cyberrafi-31{N}    {H}  ║
  {H}  ║{P}[{H}•{P}] Status    : {H}PREMIUM {P}     {N}      {H}    ║
   {H} ║{P}[{H}•{P}] Network   : {H}3G{N}, {H}4G/5G{N}, {H}ON{N}     {H}      ║
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/cyberrafi-31");mainx()
    elif mahin in ["6","06"]:
     os.system("xdg-open https://www.facebook.com/profile.php?id=61551411116495");mainx()
    elif mahin in ["0","00"]:
...
def approval():
  ...
  try:
    link='https://github.com/cyberrafi-31/Rendom-py/blob/main/Xayko.txt'
